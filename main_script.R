...
datafile_measurements = "/home/mivieijra/Documents/VLINDER/VLINDER/Measurements/Antwerp_metingen.csv"   # Directory of the datafile with the mobile measurements
...
vlinder_tropgen = "/home/mivieijra/Documents/VLINDER/VLINDER/Station_data/Vlinder_trop_gen.csv"
...
# Stations for temperature decline of Antwerp measurements
station_path_list = c(AWV_boechout, AWV_kontich, AWV_ranst, AWV_stabroek, infr_berchem, infr_ekeren, infr_lier, vlinder_beveren, vlinder_eilandje, vlinder_tropgen, vlinder_kontich, vlinder_linkeroever, VMM_luchtbal, VMM_melsele, WOW_borgerhout)
